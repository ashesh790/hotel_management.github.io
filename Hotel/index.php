...
<html lang="en">
<head>
<title>hotelRISE HOTEL</title>
<!-- for-mobile-apps -->
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="Resort Inn Responsive , Smartphone Compatible web template , Samhotelg, LG, Sony Ericsson, Motorola web design" />
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php">Hotel Haveli</a></h1>
				</div>
							...
							<!-- Modal content-->
								<div class="modal-content">
									<div class="modal-header">
										...
										<h4>hotel  <span>haveli</span></h4>
										<img src="ab.jpg" alt=" " class="img-responsive">
...
<!-- //Modal1 -->
<div id="availability-agileits" style="background-color:lightblue;>
<div class="col-md-12 book-form-left-w3layouts" style="background-color:lightblue; height:200px"> 
	<a href="admin/reservation.php"><h2 style="margin-left:500px; ">ROOM RESERVATION</h2></a>
</div> 
	...
	<div class="banner-bottom">
		<div class="container">	
			<div class="agileits_banner_bottom">
				<h3><span>Our offers</span> Find Your choice</h3>
			</div>
				...
				<ul class="cbp-ig-grid">
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">hotel haveli</span>
						</div>
					</li>
					<li>
						<div class="w3_grid_effect">
...
<div class="advantages">
	<div class="container">
		<div class="advantages-main">
				<h3 class="title-w3-agileits">Hotel Service</h3>
...
<section class="portfolio-w3ls" id="gallery">
		 <h3 class="title-w3-agileits title-black-wthree">Our Gallery</h3>
				<div class="col-md-3 gallery-grid gallery1">
					<a href="abc.jpg" class="swipebox"><img src="images/g1.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>Hotel Haveli</h4>
				...
				<div class="col-md-3 gallery-grid gallery1">
					<a href="images/g2.jpg" class="swipebox"><img src="images/g2.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>Hotel Haveli</h4>
							<p><i class="fa fa-picture-o" aria-hidden="tru	e"></i></p>
						</div>
				</a>
				</div>
				<div class="clearfix"> </div>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+91 9090909090</p>
...
<!-- /contact -->
			<!-- <div class="copy">
		        <p>© 2017 hotelRISE . All Rights Reserved | Design by <a href="index.php">hotelRISE</a> </p>
		    </div> -->
<!--/footer -->
<!-- js -->
